...
import NewLabRequest from '@/components/features/lab/new-lab-request'
import useRole from '@/hooks/useRole'
import type { Patient } from '@/types/patient.type'
import { Item } from '@/components/ui/item'
import useMedicalRecordById from '@/hooks/medical-record/useMedicalRecordById'
import NewDiagnosis from '../../components/features/medical-record/new-diagnosis'
import DiagnosisCard from '../../components/features/medical-record/diagnosis-card'
import NewPrescription from '@/components/features/medical-record/new-prescription'
import PrescriptionCard from '@/components/features/medical-record/prescription-card'
import { AppointmentStatusEnum } from '@/types/appointment.type'
import VitalCard from '@/components/features/medical-record/vital-card'
import LabTestCard from '@/components/features/medical-record/lab-test-card'
